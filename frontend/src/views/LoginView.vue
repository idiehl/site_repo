    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8 animate-fade-in">
        <div class="flex items-center justify-center mb-2">
          <img src="/atlas-apply-wordmark.svg" alt="Atlas Apply" class="h-16 w-auto" />
        </div>
      ...
      <div class="card animate-fade-in" style="animation-delay: 0.1s">
        ...
        <button
          ...
          :disabled="auth.loading"
          class="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-night-600 rounded-lg hover:bg-night-700/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-3"
        >
          ...
          <span class="text-night-200">Continue with Google</span>
        </button>
