  ...
  <div class="min-h-screen bg-dark-900 text-white">
    ...
    <main class="max-w-4xl mx-auto px-6 py-12">
      ...
      <div class="text-center mb-12">
        <div class="inline-flex items-center justify-center w-20 h-20 bg-dark-800 rounded-2xl mb-6">
      ...
      <div class="grid md:grid-cols-3 gap-6 mb-12">
        <div class="bg-dark-800 rounded-xl p-6 border border-dark-700">
          ...
          <p class="text-dark-400 text-sm">Click the extension icon or floating button to instantly save any job posting.</p>
        </div>
        ...
        <div class="bg-dark-800 rounded-xl p-6 border border-dark-700">
          ...
          <p class="text-dark-400 text-sm">AI automatically extracts job title, company, requirements, and more.</p>
        </div>
        ...
        <div class="bg-dark-800 rounded-xl p-6 border border-dark-700">
          ...
          <p class="text-dark-400 text-sm">Works directly in your browser - no scraping blocks from LinkedIn or Indeed.</p>
        </div>
      </div>
      ...
      <div class="bg-dark-800 rounded-xl border border-dark-700 overflow-hidden">
        ...
        <div class="p-6 space-y-6">
          ...
          <div>
            ...
            <p class="text-dark-400">Right-click the downloaded file and select "Extract All" to a folder you'll remember.</p>
          </div>
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-3">
              <code class="bg-dark-900 px-3 py-2 rounded text-sm text-cyan-400">chrome://extensions</code>
              <span class="text-dark-500">or</span>
              <code class="bg-dark-900 px-3 py-2 rounded text-sm text-cyan-400">edge://extensions</code>
            </div>
          </div>
          ...
          <div>
            ...
            <p class="text-dark-400">Toggle "Developer mode" in the top-right corner of the extensions page.</p>
          </div>
          ...
          <div>
            ...
            <p class="text-dark-400">Click "Load unpacked" and select the extracted folder containing the extension files.</p>
          </div>
          ...
          <div>
            ...
            <p class="text-dark-400">Click the puzzle piece icon in your toolbar, then click the pin icon next to QuickPRO to keep it visible.</p>
          </div>
        </div>
      </div>
      ...
      <div class="mt-8 text-center">
        <h3 class="text-dark-400 mb-4">Supported Job Sites</h3>
        <div class="flex flex-wrap justify-center gap-4 text-sm text-dark-300">
          <span class="px-3 py-1 bg-dark-800 rounded-full">LinkedIn</span>
          <span class="px-3 py-1 bg-dark-800 rounded-full">Indeed</span>
          <span class="px-3 py-1 bg-dark-800 rounded-full">Glassdoor</span>
          <span class="px-3 py-1 bg-dark-800 rounded-full">Lever</span>
          <span class="px-3 py-1 bg-dark-800 rounded-full">Greenhouse</span>
          <span class="px-3 py-1 bg-dark-800 rounded-full">Workday</span>
          <span class="px-3 py-1 bg-dark-800 rounded-full">+ Any job site</span>
        </div>
      </div>
    </main>
  </div>
