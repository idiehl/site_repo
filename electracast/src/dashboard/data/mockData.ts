...
export const recentComments: Comment[] = [
  {
    ...
    comment:
      'Incredible insights on edge computing! The way you explained the transition from centralized to distributed systems really clicked for me.',
  ...
  },
  {
    ...
    comment:
      'Thank you for covering this topic so thoroughly. The discussion on bias in AI systems was especially relevant.',
  ...
  },
  {
    ...
    comment:
      'Mind-blowing episode! Never thought quantum computing could be explained so clearly.',
  ...
  },
  {
    ...
    episodeTitle: 'AI Ethics in 2026: Where Do We Stand?',
    comment:
      'Would love to hear more about the regulatory frameworks being developed in Europe!',
  ...
  },
  {
    ...
    comment:
      'Great episode as always. The interview with the sustainable tech CEO was fantastic.',
